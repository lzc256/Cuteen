            ...
            value: function init(option) {
                ...
                for (var i = 0; i < this.packages.length; i++) {
                    ...
                    for (var _i = 0; _i < opackage.length; _i++) {
                        var dizhi = CUTEEN_SETTING.STATIC_PATH+'/Func/OwO/'+opackage[_i].icon;
                        if (type == "image") {
                            //html += '\n                    <li class="OwO-item" data-id="' + opackage[_i].data + '" title="' + opackage[_i].text + '">' + opackage[_i].icon + '</li>';
                           html += '<li class="OwO-item" data-id="'+opackage[_i].data+'"><img class="emoji" data-src="'+dizhi+'"></li>';
                        } else {
                            //html += '\n                    <li class="OwO-item" data-id="not-given" title="' + opackage[_i].text + '">' + opackage[_i].icon + '</li>';
                           html += `<li class="OwO-item" data-id="not-given" title="${opackage[_i].text}"><img class="emoji" data-src="${dizhi}"></li>`;
                        } 
                    }
